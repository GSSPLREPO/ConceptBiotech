...
namespace ConceptBiotech.WebAPI
{
    ...
    {
        /// <summary>
        /// Override Metod if any exception generated.
        /// </summary>
        ...
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            {
                var response = Response.CreateResponse(ResultCodes.UnAuthorize, HttpStatusCode.MethodNotAllowed);
            ...
            {
                throw new HttpResponseException(Response.CreateResponse(ResultCodes.InternalError, HttpStatusCode.InternalServerError, null, context.Exception));
